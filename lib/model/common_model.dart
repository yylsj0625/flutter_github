class CommonModel {
  ...
  CommonModel({this.totalCount, this.incompleteResults, this.items});
   factory CommonModel.fromJson(Map<String,dynamic> json, ) {
    int totalCount = json['total_count'];
    bool incompleteResults = json['incomplete_results'];
    var itemList = json['items'] as List;
    List<CommonItem> items = itemList.map((i) => CommonItem.fromJson(i)).toList();
    return CommonModel(
   ...
   Map<String,dynamic> toJson() {
     ...
     data["incompleteResults"] = this.incompleteResults;
